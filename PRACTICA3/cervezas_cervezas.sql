...
CREATE TABLE `cervezas` (
  ...
  `Grados de alcohol` varchar(45) NOT NULL,
  `Materia prima` varchar(45) NOT NULL,
  PRIMARY KEY (`ID`),
  UNIQUE KEY `Nombre_UNIQUE` (`Nombre`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Tabla de cervezas';
...
INSERT INTO `cervezas` VALUES (1,'A','250','4','malta'),(6,'B','300','7','lupulo'),(9,'C','450','5','levadura');
